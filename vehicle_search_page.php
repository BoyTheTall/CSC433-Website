...
<body>
    <form id="vehicle_search" action="vehicle_search_page.php" method="get">
...
<?php 
 ...
 $db_conn = DBOperations::getInstance();
    function search_for_cars(DBOperations $db_conn){
        ...
        $operation_results = $db_conn->search($manufacturer_id, $vehicle_type, $model_id, $colour, true, $year, $number_of_seats);
